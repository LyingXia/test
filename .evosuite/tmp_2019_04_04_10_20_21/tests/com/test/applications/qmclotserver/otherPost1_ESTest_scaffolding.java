...
public class otherPost1_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.test.applications.qmclotserver.otherPost1"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(otherPost1_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.test.applications.qmclotserver.otherPost1",
      ...
      "com.test.applications.qmclotserver.readExcel",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(otherPost1_ESTest_scaffolding.class.getClassLoader()); 
