...
public class arrtoNN {
    ...
    //NUM为要选取的元素个数
    //arr_len为原始数组的长度，为定值
    public void combine_increase(int[] arr, int start, int[] result, int count, int NUM, int arr_len) {
    ...
    //count为result数组的索引值，起辅助作用
    //NUM为要选取的元素个数
    public void combine_decrease(int[] arr, int start, int[] result, int count, int NUM) {
        ArrayList a = new ArrayList();
